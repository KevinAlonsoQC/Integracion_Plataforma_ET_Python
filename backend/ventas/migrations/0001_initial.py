# Generated by Django 4.0.3 on 2023-04-04 21:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nombre_bodega', models.CharField(max_length=255, unique=True, verbose_name='Color')),
                ('telefono', models.CharField(max_length=255, verbose_name='Paleta_Hex')),
            ],
        ),
        migrations.CreateModel(
            name='Categoria',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('nombre_sucursal', models.CharField(max_length=255, unique=True, verbose_name='Color')),
                ('telefono', models.CharField(max_length=255, verbose_name='Paleta_Hex')),
                ('comuna', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ventas.comuna')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ventas.tipo_estado')),
                ('sucursal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ventas.sucursal')),
                ('tipo_envio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ventas.tipo_envio')),
                ('tipo_impreso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ventas.tipo_impreso')),
                ('tipo_pago', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ventas.tipo_pago')),
                ('tipo_pedido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ventas.tipo_pedido')),
